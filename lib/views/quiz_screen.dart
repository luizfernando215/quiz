...
class QuizScreen extends StatefulWidget {
  ...
  const QuizScreen({super.key, required this.questionlenght, required this.optionsList, required this.topicType});
...
class _QuizScreenState extends State<QuizScreen> {
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          if (myquestions.isLocked) {
                                            if (questionOption == myquestions.selectedWiidgetOption) {
                                              color = questionOption.isCorrect ? Colors.green : Colors.red;
                                          ...
                                          return InkWell(
                                            onTap: () {
                                              ...
                                              if (!myquestions.isLocked) {
                                                ...
                                                if (myquestions.selectedWiidgetOption.isCorrect) {
                                                  score++;
                                                }
                                              }
                                            },
  ...
  ElevatedButton buildElevatedButton() {
    ...
    return ElevatedButton(
      ...
      child: Text(
        _questionNumber < widget.questionlenght.length ? 'Next Question' : 'Result',
